...
import org.itis.gr404.mvc.validator.CarValidator;
...
public class CarNewValidateController {
    ...
    public String onSubmit(@ModelAttribute("car") Car car, BindingResult bindingResult){
